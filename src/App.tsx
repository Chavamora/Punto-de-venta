...
function App() {
  ...
  const products: Product[] = [
    { id: "1", name: "Manzana", price: 25.5, stock: 3, isWeighted: true },
    { id: "2", name: "Plátano", price: 22.0, stock: 4, isWeighted: true },
    {
      id: "3",
      name: "Leche",
      price: 28.5,
      stock: 10,
      barcode: "7501055901234",
    },
    { id: "4", name: "Pan", price: 35.0, stock: 2, promotion: "2x1" },
  ];
              ...
              <div className="grid grid-cols-3 gap-4">
                {products.map((product) => (
                  ...
                  >
                    ...
                    >
                      Stock: {product.stock}{" "}
                      {product.isWeighted ? "kg" : "unidades"}
                    </p>
                  </div>
                ))}
              </div>
